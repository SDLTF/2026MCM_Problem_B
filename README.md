这是一个为您准备的 `README.md` 模板，专门针对您 2026 MCM Problem B（月球殖民地物流优化）的项目进行了详细整理。它包含了项目背景、模型核心逻辑、文件结构以及研究结论。
...
这是一个为您生成的 `README.md` 文档草稿，详细解释了您 GitHub 仓库中每个文件夹和文件的作用。您可以直接复制以下内容。

---

# 2026 MCM Problem B 解决方案代码库结构说明

本仓库包含了针对 **2026 MCM Problem B (建立月球殖民地)** 的完整数学建模解决方案。以下是仓库中各文件夹及文件的详细用途说明。
